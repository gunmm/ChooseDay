...
-(void)nowMonthCalendar:(NSString*)dateStr complete:(void(^)(NSDictionary*))completionBlk{
    NSString* preMonthStr=[self NowMonthOfMonthString:dateStr];
    [self getCalendarMapWith:preMonthStr completion:completionBlk];
}
...
-(NSString*)NowMonthOfMonthString:(NSString*)dateStr{
    //    NSDate* date=[self dateFromMonthString:dateStr];
