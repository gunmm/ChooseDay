...
typedef NS_ENUM(NSUInteger, ML_SSKeychainQuerySynchronizationMode) {
	ML_SSKeychainQuerySynchronizationModeAny,
	ML_SSKeychainQuerySynchronizationModeNo,
	ML_SSKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface ML_SSKeychainQuery : NSObject
...
@property (nonatomic) ML_SSKeychainQuerySynchronizationMode synchronizationMode;
#endif
