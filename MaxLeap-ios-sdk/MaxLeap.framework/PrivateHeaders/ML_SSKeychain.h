...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, ML_SSKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	ML_SSKeychainErrorBadArguments = -1001,
};

/** SSKeychain error domain */
FOUNDATION_EXPORT NSString *const ML_kSSKeychainErrorDomain;

/** Account name. */
FOUNDATION_EXPORT NSString *const ML_kSSKeychainAccountKey;
 ...
 */
FOUNDATION_EXPORT NSString *const ML_kSSKeychainCreatedAtKey;

/** Item class. */
FOUNDATION_EXPORT NSString *const ML_kSSKeychainClassKey;

/** Item description. */
FOUNDATION_EXPORT NSString *const ML_kSSKeychainDescriptionKey;

/** Item label. */
FOUNDATION_EXPORT NSString *const ML_kSSKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
FOUNDATION_EXPORT NSString *const ML_kSSKeychainLastModifiedKey;

/** Where the item was created. */
FOUNDATION_EXPORT NSString *const ML_kSSKeychainWhereKey;
 ...
 */
@interface ML_SSKeychain : NSObject
